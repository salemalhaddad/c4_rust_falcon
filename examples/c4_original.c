...
const char *token_names[] = {
    "Num", "Fun", "Sys", "Glo", "Loc", "Id", "Char", "Else", "Enum", "If",
    "Int", "Return", "Sizeof", "While", "Assign", "Cond", "Lor", "Lan",
        ...
        if (tk == Assign) {
            ...
            *++e = BZ;
            ...
            if (tk == ':') next();
                ...
                printf("%lld: conditional missing colon\n", line);
                exit(-1);
            }
            *d = (int)(e + 3);
            *++e = JMP;
            ...
            *++e = MOD;
            ...
            if (*e == LC) {
                ...
                *++e = LI;
                ...
                printf("%lld: bad lvalue in post-increment\n", line);
                exit(-1);
            }
            *++e = PSH;
            *++e = IMM;
            ...
            *++e = PSH;
            ...
            if (tk == ']') next();
                ...
                printf("%lld: close bracket expected\n", line);
                exit(-1);
            }
            if (t > PTR) {
                *++e = PSH;
...
int main(signed argc, char **argv) {
    ...
    if (!(sp = malloc(poolsz))) {
        printf("could not malloc(%lld) stack area\n", poolsz);
        return -1;
    }
    ...
    *--sp = (int)t;
    ...
    while (1) {
		...
		sp += argc = *sp;
		a = (int)printf((char *)sp[-1], sp[-2], sp[-3], sp[-4], sp[-5], sp[-6]);
		}
		else if (i == MALC) a = (int)malloc(*sp);
		else if (i == FREE) free((void *)*sp);
		else if (i == MSET) a = (int)memset((char *)sp[2], sp[1], *sp);
		else if (i == MCMP) a = memcmp((char *)sp[2], (char *)sp[1], *sp);
		else if (i == EXIT) { printf("exit(%lld)\n", *sp); return *sp; }
		else {
